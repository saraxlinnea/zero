export const DAILY_FORECASTS = [
  "Want a long sniff at the fire hydrant. Non-negotiable.",
  ...
  "Ender needs supervision. Guardian mode activated.",
  ...
  "Ocean dirt from Santa Cruz still counts as honorable.",
  ...
  "Lake crossings start with confidence and dog paddle dignity.",
